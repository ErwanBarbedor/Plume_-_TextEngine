...
return function (plume)
    ...
    function plume.load_macros()
        ...
        require "plume-engine.macros.controls" (plume)
        require "plume-engine.macros.macros"   (plume)
        require "plume-engine.macros.utils"    (plume)
        require "plume-engine.macros.files"    (plume)
        require "plume-engine.macros.eval"     (plume)
        require "plume-engine.macros.spaces"   (plume)
    end
end