--[[
Plume - TextEngine 0.5.0 (Lua 5.1)
...
local plume = {}
plume._VERSION = "Plume - TextEngine 0.5.0 (Lua 5.1)"
...
-- @option_kw silent Execute the code without returning anything. Usefull for filtering unwanted function return : `#{table.remove(t)}[silent]`
